...
impl Database {
    pub fn new(db_path: &Path) -> lumen_core::Result<Self> {
        // Create parent directories if they don't exist
        if let Some(parent) = db_path.parent() {
            std::fs::create_dir_all(parent).map_err(LumenError::Io)?;
        }
    ...
    fn init_schema(&self) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        .map_err(|e| LumenError::Database(e.to_string()))?;
        Self::add_dimension_columns(&conn);
    ...
    pub fn add_bookmark(&self, bookmark: &Bookmark) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn add_bookmarks_for(&self, wallpaper_ids: &[String]) -> lumen_core::Result<usize> {
    ...
    pub fn remove_bookmarks_for(&self, wallpaper_ids: &[String]) -> lumen_core::Result<usize> {
        if wallpaper_ids.is_empty() {
            return Ok(0);
        }
        let mut conn = self
    ...
    pub fn remove_bookmark(&self, id: Uuid) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_bookmarks(&self, folder_id: Option<Uuid>) -> lumen_core::Result<Vec<Bookmark>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for b in iter {
            bookmarks.push(b.map_err(|e| LumenError::Database(e.to_string()))?);
        }
    ...
    pub fn get_bookmarked_wallpapers(
    ...
    ) -> lumen_core::Result<Vec<Wallpaper>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for row in rows {
            let json = row.map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn collection_counts(
        &self,
    ) -> lumen_core::Result<std::collections::HashMap<Uuid, u32>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for row in rows {
            let (id, count) = row.map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn is_bookmarked(&self, wallpaper_id: &str) -> lumen_core::Result<bool> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn add_folder(&self, folder: &BookmarkFolder) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_folders(&self) -> lumen_core::Result<Vec<BookmarkFolder>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for f in iter {
            folders.push(f.map_err(|e| LumenError::Database(e.to_string()))?);
        }

        Ok(folders)
    }

    pub fn delete_bookmark_folder(&self, id: Uuid) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_preferences(&self) -> lumen_core::Result<AppPreferences> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        if let Some(data) = json {
            serde_json::from_str(&data).map_err(|e| LumenError::Json(e))
        } else {
            Ok(AppPreferences::default())
        }
    }

    pub fn save_preferences(&self, prefs: &AppPreferences) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        let json = serde_json::to_string(prefs).map_err(|e| LumenError::Json(e))?;
    ...
    pub fn cache_wallpapers(&self, wallpapers: &[Wallpaper]) -> lumen_core::Result<()> {
            ...
            .map_err(|e| LumenError::Database(e.to_string()))?;
        {
            ...
            for wallpaper in wallpapers {
                let json = serde_json::to_string(wallpaper).map_err(LumenError::Json)?;
    ...
    pub fn wallpaper_cache_count(&self) -> lumen_core::Result<u32> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn cache_wallpaper(&self, wallpaper: &Wallpaper) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        let json = serde_json::to_string(wallpaper).map_err(|e| LumenError::Json(e))?;
    ...
    pub fn prune_wallpaper_cache(&self, keep: u32) -> lumen_core::Result<usize> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_cached_wallpaper(&self, id: &str) -> lumen_core::Result<Option<Wallpaper>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        if let Some(data) = json {
            let wp = serde_json::from_str(&data).map_err(|e| LumenError::Json(e))?;
            Ok(Some(wp))
        } else {
            Ok(None)
        }
    ...
    pub fn add_download_record(&self, record: &DownloadRecord) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_download_records(&self, limit: u32) -> lumen_core::Result<Vec<DownloadRecord>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for r in iter {
            records.push(r.map_err(|e| LumenError::Database(e.to_string()))?);
        }
    ...
    pub fn add_download_folder(&self, folder: &DownloadFolder) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_download_folders(&self) -> lumen_core::Result<Vec<DownloadFolder>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_download_folder_by_id(
        &self,
        id: Uuid,
    ) -> lumen_core::Result<Option<DownloadFolder>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn delete_download_folder(&self, id: Uuid) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn add_local_wallpaper(&self, lw: &LocalWallpaper) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_local_wallpapers(
        &self,
        folder_id: Option<Uuid>,
    ) -> lumen_core::Result<Vec<LocalWallpaper>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for lw in iter {
            result.push(lw.map_err(|e| LumenError::Database(e.to_string()))?);
        }
        Ok(result)
    }
    ...
    pub fn remove_local_wallpaper(&self, id: Uuid) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn get_tracked_local_paths(&self) -> lumen_core::Result<std::collections::HashSet<String>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for p in iter {
            paths.insert(p.map_err(|e| LumenError::Database(e.to_string()))?);
        }
        Ok(paths)
    }
}
...
impl Database {
    ...
    pub fn import_folder(&self, path: &str, name: &str) -> lumen_core::Result<Uuid> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn imported_folders(&self) -> lumen_core::Result<Vec<(Uuid, String, String, u32)>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for row in rows {
            let (id, name, path, count) =
                row.map_err(|e| LumenError::Database(e.to_string()))?;
            if let Ok(uuid) = Uuid::parse_str(&id) {
    ...
    pub fn remove_imported_folder(&self, id: Uuid) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn sync_imported_wallpapers(
        &self,
        folder_id: Uuid,
        files: &[(String, String, u64, String, u32, u32)],
    ) -> lumen_core::Result<usize> {
        let mut conn = self
            .pool
            .get()
            ...
            .map_err(|e| LumenError::Database(e.to_string()))?;
        {
            ...
            let on_disk: std::collections::HashSet<&str> =
                files.iter().map(|(path, ..)| path.as_str()).collect();
            ...
            let mut insert = transaction
                .prepare_cached(
                    "INSERT INTO imported_wallpapers
                        (id, folder_id, path, filename, file_size, subpath, width, height)
                     VALUES (?1, ?2, ?3, ?4, ?5, ?6, ?7, ?8)
                     ON CONFLICT(path) DO UPDATE SET
                        ...
                        -- A rescan that could not read a header must not erase
                        -- a size that was read successfully before.
                        width = CASE WHEN excluded.width > 0
                                     THEN excluded.width ELSE width END,
                        height = CASE WHEN excluded.height > 0
                                      THEN excluded.height ELSE height END",
                )
                .map_err(|e| LumenError::Database(e.to_string()))?;
            for (path, filename, size, subpath, width, height) in files {
                insert
                    .execute((
    ...
    pub fn imported_wallpapers(
        ...
        folder_id: Option<Uuid>,
        favorites_only: bool,
    ) -> lumen_core::Result<Vec<(Uuid, Uuid, String, String, u64, bool, String, u32, u32)>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for row in rows {
            let (id, folder, path, filename, size, favorite, subpath, width, height) =
                row.map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    /// Adds the pixel-size columns to a database that predates them.
    fn add_dimension_columns(conn: &rusqlite::Connection) {
        // Errors are the expected case on every launch after the first.
        let _ = conn.execute(
            "ALTER TABLE imported_wallpapers ADD COLUMN width INTEGER NOT NULL DEFAULT 0", []);
        let _ = conn.execute(
            "ALTER TABLE imported_wallpapers ADD COLUMN height INTEGER NOT NULL DEFAULT 0", []);
    }
    ...
    pub fn set_imported_favorite(&self, id: Uuid, favorite: bool) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
...
impl Database {
    ...
    pub fn wallpaper_history(
        &self,
        limit: u32,
    ) -> lumen_core::Result<Vec<(Option<String>, String, String, String)>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        for row in rows {
            history.push(row.map_err(|e| LumenError::Database(e.to_string()))?);
        }
        Ok(history)
    }

    /// Drops the most recent entry, so undo does not walk back onto itself.
    pub fn drop_latest_history(&self) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
...
impl Database {
    ...
    pub fn add_subscription(
        ...
        if let Some(id) = existing {
            ...
            .map_err(|e| LumenError::Database(e.to_string()))?;
            return Uuid::parse_str(&id).map_err(|e| LumenError::Database(e.to_string()));
        }
    ...
    pub fn subscriptions(
        &self,
    ) -> lumen_core::Result<Vec<(Uuid, String, String, u32, Option<String>, u32)>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn remove_subscription(&self, id: Uuid) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn clear_subscription_unseen(&self, id: Uuid) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
...
impl Database {
    ...
    pub fn all_prints(&self) -> lumen_core::Result<Vec<(String, Vec<u8>)>> {
        ...
        for row in rows {
            prints.push(row.map_err(|e| LumenError::Database(e.to_string()))?);
        }
        Ok(prints)
    }

    /// Paths that already have a print, so only new files are computed.
    pub fn printed_paths(&self) -> lumen_core::Result<std::collections::HashSet<String>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
        ...
        let mut paths = std::collections::HashSet::new();
        for row in rows {
            paths.insert(row.map_err(|e| LumenError::Database(e.to_string()))?);
        }
        Ok(paths)
    }

    /// Drops prints for files that are no longer on disk.
    pub fn prune_prints(&self) -> lumen_core::Result<usize> {
...
impl Database {
    ...
    pub fn crop(
        ...
        path: &str,
        display: &str,
    ) -> lumen_core::Result<Option<(f64, f64, f64, f64)>> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
    ...
    pub fn clear_crop(&self, path: &str, display: &str) -> lumen_core::Result<()> {
        let conn = self
            .pool
            .get()
            .map_err(|e| LumenError::Database(e.to_string()))?;
...
mod tests {
    use super::*;
    use lumen_core::{Category, Purity, Resolution, WallpaperProvider};
    ...
    fn syncing_adds_new_files_and_drops_missing_ones() {
        ...
        let first = vec![
            ("/tmp/walls/a.jpg".to_string(), "a.jpg".to_string(), 10, String::new(), 1920, 1080),
            ("/tmp/walls/b.jpg".to_string(), "b.jpg".to_string(), 20, "nested".to_string(), 1920, 1080),
        ];
        ...
        let second = vec![
            ("/tmp/walls/a.jpg".to_string(), "a.jpg".to_string(), 10, String::new(), 1920, 1080),
            ("/tmp/walls/c.jpg".to_string(), "c.jpg".to_string(), 30, String::new(), 1920, 1080),
        ];
    ...
    fn a_favourite_survives_a_rescan() {
        let (db, _dir) = temp_db();
        let folder = db.import_folder("/tmp/walls", "walls").expect("import");
        let files = vec![("/tmp/walls/a.jpg".to_string(), "a.jpg".to_string(), 10, String::new(), 1920, 1080)];
